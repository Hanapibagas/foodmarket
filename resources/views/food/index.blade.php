<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-10">
                <a href="{{ route('food.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">+ Create user </a>
            </div>
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="boder px-6 py-4">{{ $item->id }}</td>
                            <td class="boder px-6 py-4">{{ $item->name }}</td>
                            <td class="boder px-6 py-4">{{ number_format($item->price) }}</td>
                            <td class="boder px-6 py-4">{{ $item->rate }}</td>
                            <td class="boder px-6 py-4">{{ $item->types }}</td>
                            <td class="boder px-6 py-4 text-center">
